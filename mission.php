...
<html lang="en">
<head>
<title>UjalaEPakistan | Mission</title>
<meta charset="utf-8">
          ...
          <div class="line1">
            <div class="line2 wrapper">
              <section class="col1">
                ...
                Hope Center is one of free website tem- plates by TemplateMonster.com, opti- mized for 1024X768 res. </section>
              <section class="col1 pad_left1">
                <h4 class="color2">Co-Founder</h4>
                <div class="pad_bot1">
                  <figure><img src="images/team2.jpeg" alt=""></figure>
                </div>
                This Hope Center Template goes with two packages – with PSD source files and without them.</section>
              <section class="col1 pad_left1">
                <h4 class="color3">Director</h4>
                <div class="pad_bot1">
                  <figure><img src="images/team3.jpg" alt=""></figure>
                </div>
                This website template has several pages SContact Us </section>
            </div>
          </div>
        </div>
      </div>
